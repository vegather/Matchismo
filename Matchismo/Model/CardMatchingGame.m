...
- (void)twoOutOfThreeGameFlipCardAtIndex:(NSUInteger)index
{
...
//            //Loop through all our cards
//            for (Card * otherCard in self.cards)//Card *currentCard in self.cards)
//            {
//                //Check if there are other cards that are faced up
//                //and playable, in which case we might have a match
...
//                             usingGameDifficulty:self.gameDifficulty];
//                    //If we have a match
//                    if (matchScore != 0)
//                    {
...
//                                                secondOtherCard.content, firstOtherCard.content,
//                                                card.content, MISMATCH_PENALTY];
//                    }
//                }
//            }
...
- (void)flipCardAtIndex:(NSUInteger)index
{
    ...
    if (self.gameDifficulty == 0)
    {
        [self twoOutOfThreeGameFlipCardAtIndex:index];
    }
    //Medium
